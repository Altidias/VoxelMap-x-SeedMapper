...
public enum EnumOptionsMinimap {
    ...
    WAYPOINT_COMPASS_OUTLINE_OPACITY("options.minimap.waypoints.compassOutlineOpacity", Type.FLOAT),
    WAYPOINT_COMPASS_BACKGROUND_OPACITY("options.minimap.waypoints.compassBackgroundOpacity", Type.FLOAT),
    ...
    WORLDMAP_HIDE_MULTIWORLD_BUTTON("options.worldmap.hideMultiworldButton", Type.BOOLEAN),
